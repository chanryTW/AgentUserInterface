      ...
      <div className="w-96 flex flex-col border-r border-gray-200 bg-white shadow-sm z-10">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin scrollbar-thumb-gray-200">
          <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 mb-6">
            <p className="text-sm font-semibold text-blue-800 mb-2">💡 試試看：</p>
            <ul className="text-sm text-blue-700 space-y-2">
              <li className="flex items-center cursor-pointer hover:underline" onClick={() => setInput('請幫我比較 iPhone 15 和 16 的規格')}>
                <span className="mr-2">📊</span>
                <span>比較 iPhone 15 和 16</span>
              </li>
              <li className="flex items-center cursor-pointer hover:underline" onClick={() => setInput('我想報名參加下週的研討會')}>
                <span className="mr-2">📝</span>
                <span>報名參加研討會</span>
              </li>
              <li className="flex items-center cursor-pointer hover:underline" onClick={() => setInput('介紹一下馬斯克是誰')}>
                <span className="mr-2">📇</span>
                <span>介紹馬斯克</span>
              </li>
            </ul>
        ...
        <div className="h-full w-full flex items-center justify-center p-12 overflow-y-auto relative z-0">
          {activeComponent ? (
            ...
            <div className="text-center space-y-4 max-w-md">
              ...
              <h2 className="text-2xl font-bold text-gray-800">動態 UI 畫布</h2>
              <p className="text-gray-500 leading-relaxed">
                此區域將顯示 Agent 根據您的對話動態生成的豐富 UI 元件。
              </p>
            </div>
          )}
        </div>
